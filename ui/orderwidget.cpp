...
//        orderList.append(new OrderObject(orderDetail.itemDetail(), orderDetail.orderIndexId(),
//            orderDetail.arabicName(), orderDetail.getSizeDescription(), QString::number(orderDetail.cash()), orderDetail.getCategoryId()));
//    }
